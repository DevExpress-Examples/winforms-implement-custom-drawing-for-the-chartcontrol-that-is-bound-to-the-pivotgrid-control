...
Namespace WindowsFormsApplication8
	Partial Public Class Form1
		...
		Private Shared seriesArguments() As String = { "FAR WEST", "GREAT LAKES", "MIDEAST", "NEW ENGLAND", "PLAINS", "ROCKY MOUNTAIN", "SOUTHEAST", "SOUTHWEST" }

		Private Shared seriesColors() As Color = { Color.Aqua, Color.Aquamarine, Color.BlueViolet, Color.Crimson, Color.DarkOrange, Color.DarkSeaGreen, Color.Green, Color.Indigo }
		#End Region
		...
		Private Sub chartControl1_CustomDrawSeries(ByVal sender As Object, ByVal e As CustomDrawSeriesEventArgs) Handles chartControl1.CustomDrawSeries
			...
			UpdateDrawOptions(CType(e.SeriesDrawOptions, BarDrawOptions))
			UpdateDrawOptions(CType(e.LegendDrawOptions, BarDrawOptions))
		...
		Private Shared Function GetIndexByName(ByVal name As Object) As Integer
			If name IsNot Nothing Then
				For i As Integer = 0 To seriesArguments.Length - 1
					If seriesArguments(i) = name.ToString() Then
						Return i
					End If
				Next i
			End If
